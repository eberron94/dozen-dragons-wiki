...
The nature of the setting, the planned campaign, and the GM's time maintain this wiki and other tools has put a soft restriction on certain classes. If you wish to play any of these classes, concact the GM to discuss options.

**Gunslinger** Eberron does not have firearms. The Gunslinger can be reflavored as a Wandslinger, but the extensive rewriting is beyond the scope of this wiki. If you wish to play a Wandslinger, contact the GM to discuss options.

**Investigator** The Investigator focuses on mysteries and intrigue, which the currently planned campaign does not feature heavily. As a result, this class would not see its full potential. If you wish to play an Investigator, contact the GM to discuss options.

**Psychic** A very new class, so the GM has not had time to read into it and the automatic card generator might be missing some feats. Additionally, Eberron's psionics are mostly focused on the kalashtar which will not feature much in the campaign. If you wish to play a Psychic, contact the GM to discuss options.

**Summoner** A relatively complex class which cannot be easily displayed in this wiki. There is no real restriction, but you will have to read up on the class from [Archives of Nethys](https://2e.aonprd.com/Classes.aspx?ID=18).

**Thaumaturge** A very new class, so the GM has not had time to read into it and the automatic card generator might be missing some feats. If you wish to play a Thaumaturge, contact the GM to discuss options.
