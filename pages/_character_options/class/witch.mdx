...
You learn the {{{ref "spell.focus.1st.apg.phase-familiar"}}} hex, which you can cast as a reaction to protect your familiar from harm, and a hex spell determined by your First Lesson class feature. You learn most other hexes by taking certain witch feats.

{{{card "spell.focus.1st.apg.phase-familiar"}}}
