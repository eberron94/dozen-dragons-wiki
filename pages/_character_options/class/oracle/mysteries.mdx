...
-   You gain the {{{ref "spell.cantrip.1st.crb.guidance"}}} cantrip
-   You gain the {{{ref "spell.focus.1st.apg.ancestral-touch"}}} revelation spell

{{{card "spell.cantrip.1st.crb.guidance"}}}

{{{card "spell.focus.1st.apg.ancestral-touch"}}}
...
-   **Soul** you gain {{{ref "spell.focus.1st.logm.eject-soul"}}} as a revelation spell
-   **Family** you gain {{{ref "spell.focus.1st.crb.soothing-words"}}} as a revelation spell

{{{card "spell.focus.1st.logm.eject-soul"}}}

{{{card "spell.focus.1st.crb.soothing-words"}}}
...
-   **Advanced Revelation** {{{ref "spell.focus.3rd.apg.ancestral-defense"}}}
-   **Greater Revelation** {{{ref "spell.focus.6th.apg.ancestral-form"}}}

{{{card "spell.focus.3rd.apg.ancestral-defense"}}}

{{{card "spell.focus.6th.apg.ancestral-form"}}}
...
-   You gain the {{{ref "spell.cantrip.1st.crb.shield"}}} cantrip
-   You gain the {{{ref "spell.focus.1st.apg.call-to-arms"}}} revelation spell

{{{card "spell.cantrip.1st.crb.shield"}}}

{{{card "spell.focus.1st.apg.call-to-arms"}}}

{{{featureClass "Divine Domain Revelation" level=1 id='Battle'}}}

Choose one of the following cleric domains, you gain the initial domain spell from it. The spell gains the cursebound trait and becomes a revelation spell for you.

-   **Might** you gain {{{ref "spell.focus.1st.crb.athletic-rush"}}} as a revelation spell
-   **Zeal** you gain {{{ref "spell.focus.1st.crb.weapon-surge"}}} as a revelation spell

{{{card "spell.focus.1st.crb.athletic-rush"}}}

{{{card "spell.focus.1st.crb.weapon-surge"}}}
...
-   **Advanced Revelation** {{{ref "spell.focus.3rd.apg.battlefield-persistence"}}}
-   **Greater Revelation** {{{ref "spell.focus.6th.apg.heroic-feat"}}}

{{{card "spell.focus.3rd.apg.battlefield-persistence"}}}

{{{card "spell.focus.6th.apg.heroic-feat"}}}
...
-   You gain the {{{ref "spell.cantrip.1st.crb.chill-touch"}}} cantrip
-   You gain the {{{ref "spell.focus.1st.apg.soul-siphon"}}} revelation spell

{{{card "spell.cantrip.1st.crb.chill-touch"}}}

{{{card "spell.focus.1st.apg.soul-siphon"}}}

{{{featureClass "Divine Domain Revelation" level=1 id='Bones'}}}

Choose one of the following cleric domains, you gain the initial domain spell from it. The spell gains the cursebound trait and becomes a revelation spell for you.

-   **Death** you gain {{{ref "spell.focus.1st.crb.deaths-call"}}} as a revelation spell
-   **Undeath** you gain {{{ref "spell.focus.1st.crb.touch-of-undeath"}}} as a revelation spell

{{{card "spell.focus.1st.crb.deaths-call"}}}

{{{card "spell.focus.1st.crb.touch-of-undeath"}}}
...
-   **Advanced Revelation** {{{ref "spell.focus.3rd.apg.armor-of-bones"}}}
-   **Greater Revelation** {{{ref "spell.focus.6th.apg.claim-undead"}}}

{{{card "spell.focus.3rd.apg.armor-of-bones"}}}

{{{card "spell.focus.6th.apg.claim-undead"}}}
...
-   You gain the {{{ref "spell.cantrip.1st.crb.dancing-lights"}}} cantrip
-   You gain the {{{ref "spell.focus.1st.apg.spray-of-stars"}}} spell

{{{card "spell.cantrip.1st.crb.dancing-lights"}}}

{{{card "spell.focus.1st.apg.spray-of-stars"}}}

{{{featureClass "Divine Domain Revelation" level=1 id='Cosmos'}}}

Choose one of the following cleric domains, you gain the initial domain spell from it. The spell gains the cursebound trait and becomes a revelation spell for you.

-   **Darkness** you gain {{{ref "spell.focus.1st.crb.cloak-of-shadow"}}} as a revelation spell
-   **Moon** you gain {{{ref "spell.focus.1st.crb.moonbeam"}}} as a revelation spell

{{{card "spell.focus.1st.crb.cloak-of-shadow"}}}

{{{card "spell.focus.1st.crb.moonbeam"}}}
...
-   **Advanced Revelation** {{{ref "spell.focus.3rd.apg.interstellar-void"}}}
-   **Greater Revelation** {{{ref "spell.focus.6th.apg.moonlight-bridge"}}}

{{{card "spell.focus.3rd.apg.interstellar-void"}}}

{{{card "spell.focus.6th.apg.moonlight-bridge"}}}
...
-   You gain the {{{ref "spell.cantrip.1st.crb.produce-flame"}}} cantrip
-   You gain the {{{ref "spell.focus.1st.apg.incendiary-aura"}}} revelation spell

{{{card "spell.cantrip.1st.crb.produce-flame"}}}

{{{card "spell.focus.1st.apg.incendiary-aura"}}}

{{{featureClass "Divine Domain Revelation" level=1 id='Flames'}}}

Choose one of the following cleric domains, you gain the initial domain spell from it. The spell gains the cursebound trait and becomes a revelation spell for you.

-   **Fire** you gain {{{ref "spell.focus.1st.crb.fire-ray"}}} as a revelation spell
-   **Sun** you gain {{{ref "spell.focus.1st.crb.dazzling-flash"}}} as a revelation spell

{{{card "spell.focus.1st.crb.fire-ray"}}}

{{{card "spell.focus.1st.crb.dazzling-flash"}}}
...
-   **Advanced Revelation** {{{ref "spell.focus.3rd.apg.whirling-flames"}}}
-   **Greater Revelation** {{{ref "spell.focus.6th.apg.flaming-fusillade"}}}

{{{card "spell.focus.3rd.apg.whirling-flames"}}}

{{{card "spell.focus.6th.apg.flaming-fusillade"}}}
...
-   You are trained in Medicine
-   You gain the {{{ref "spell.cantrip.1st.crb.stabilize"}}} cantrip
-   You gain the {{{ref "spell.focus.1st.apg.life-link"}}} revelation spell

{{{card "spell.cantrip.1st.crb.stabilize"}}}

{{{card "spell.focus.1st.apg.life-link"}}}

{{{featureClass "Divine Domain Revelation" level=1 id='Life'}}}

Choose one of the following cleric domains, you gain the initial domain spell from it. The spell gains the cursebound trait and becomes a revelation spell for you.

-   **Healing** you gain {{{ref "spell.focus.1st.crb.healers-blessing"}}} as a revelation spell
-   **Repose** you gain {{{ref "spell.focus.1st.logm.share-burden"}}} as a revelation spell

{{{card "spell.focus.1st.crb.healers-blessing"}}}

{{{card "spell.focus.1st.logm.share-burden"}}}
...
-   **Advanced Revelation** {{{ref "spell.focus.3rd.apg.delay-affliction"}}}
-   **Greater Revelation** {{{ref "spell.focus.6th.apg.life-giving-form"}}}

{{{card "spell.focus.3rd.apg.delay-affliction"}}}

{{{card "spell.focus.6th.apg.life-giving-form"}}}
...
-   You gain the {{{ref "spell.cantrip.1st.crb.read-aura"}}} cantrip
-   You gain the {{{ref "spell.focus.1st.apg.brain-drain"}}} revelation spell

{{{card "spell.cantrip.1st.crb.read-aura"}}}

{{{card "spell.focus.1st.apg.brain-drain"}}}

{{{featureClass "Divine Domain Revelation" level=1 id='Lore'}}}

Choose one of the following cleric domains, you gain the initial domain spell from it. The spell gains the cursebound trait and becomes a revelation spell for you.

-   **Knowledge** you gain {{{ref "spell.focus.1st.crb.scholarly-recollection"}}} as a revelation spell
-   **Truth** you gain {{{ref "spell.focus.1st.crb.word-of-truth"}}} as a revelation spell

{{{card "spell.focus.1st.crb.scholarly-recollection"}}}

{{{card "spell.focus.1st.crb.word-of-truth"}}}
...
-   **Advanced Revelation** {{{ref "spell.focus.3rd.apg.access-lore"}}}
-   **Greater Revelation** {{{ref "spell.focus.6th.apg.dread-secret"}}}

{{{card "spell.focus.3rd.apg.access-lore"}}}

{{{card "spell.focus.6th.apg.dread-secret"}}}
...
-   You are trained in Nature
-   You gain the {{{ref "spell.cantrip.1st.crb.electric-arc"}}} cantrip
-   You gain the {{{ref "spell.focus.1st.apg.tempest-touch"}}} revelation spell

{{{card "spell.cantrip.1st.crb.electric-arc"}}}

{{{card "spell.focus.1st.apg.tempest-touch"}}}

{{{featureClass "Divine Domain Revelation" level=1 id='Tempest'}}}

Choose one of the following cleric domains, you gain the initial domain spell from it. The spell gains the cursebound trait and becomes a revelation spell for you.

-   **Lightning** you gain {{{ref "spell.focus.1st.logm.charged-javelin"}}} as a revelation spell
-   **Water** you gain {{{ref "spell.focus.1st.crb.tidal-surge"}}} as a revelation spell

{{{card "spell.focus.1st.logm.charged-javelin"}}}

{{{card "spell.focus.1st.crb.tidal-surge"}}}
...
-   **Advanced Revelation** {{{ref "spell.focus.3rd.apg.thunderburst"}}}
-   **Greater Revelation** {{{ref "spell.focus.6th.apg.tempest-form"}}}

{{{card "spell.focus.3rd.apg.thunderburst"}}}

{{{card "spell.focus.6th.apg.tempest-form"}}}
...
-   You gain the {{{ref "spell.cantrip.1st.da.time-sense"}}} cantrip
-   You gain the {{{ref "spell.focus.1st.da.temporal-distortion"}}} revelation spell

{{{card "spell.cantrip.1st.da.time-sense"}}}

{{{card "spell.focus.1st.da.temporal-distortion"}}}

{{{featureClass "Divine Domain Revelation" level=1 id='Time'}}}

Choose one of the following cleric domains, you gain the initial domain spell from it. The spell gains the cursebound trait and becomes a revelation spell for you.

-   **Fate** you gain {{{ref "spell.focus.1st.crb.read-fate"}}} as a revelation spell
-   **Time** you gain {{{ref "spell.focus.1st.logm.delay-consequence"}}} as a revelation spell

{{{card "spell.focus.1st.crb.read-fate"}}}

{{{card "spell.focus.1st.logm.delay-consequence"}}}
...
-   **Advanced Revelation** {{{ref "spell.focus.3rd.da.time-skip"}}}
-   **Greater Revelation** {{{ref "spell.focus.6th.da.manifold-lives"}}}

{{{card "spell.focus.3rd.da.time-skip"}}}

{{{card "spell.focus.6th.da.manifold-lives"}}}
