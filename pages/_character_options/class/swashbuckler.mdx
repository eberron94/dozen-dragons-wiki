...
A list of all swashbuckler's styles can be found [here](/class/swashbuckler/styles.html).
...
You gain an elegant finishing attack you can make when you have panache. You gain the {{{ref "action.class.swashbuckler.apg.confident-finisher"}}} action.

{{{card "action.class.swashbuckler.apg.confident-finisher"}}}

{{{featureClass "Opportune Riposte" level=3}}}

You turn the tables on foes who fumble, capitalizing immediately on their mistake. You gain the {{{ref "action.class.swashbuckler.apg.opportune-riposte"}}} reaction.
...
As a swashbuckler at the peak of your skill, you swell with confidence and bravado in every attack. When you Strike as part of a finisher or {{{ref "action.class.swashbuckler.apg.opportune-riposte"}}}, you can give the Strike the failure effect from the {{{ref "action.class.swashbuckler.apg.confident-finisher"}}} action, including the increase from {{{ref "feat.class.swashbuckler.apg.precise-finisher"}}} if you have that feat. You can do so only if the Strike uses a weapon or unarmed attack that you could use for {{{ref "action.class.swashbuckler.apg.confident-finisher"}}}.
