...
The race cuts an impressive visage. In part because of their height and lean musculature, gnolls are very quick compared with many other races such as humans. Gnoll skin is a greenish-gray, and their furry hide is light or dark brown, marked sometimes with spots or stripes. Many gnolls also have a dirty yellow to reddish-gray crestlike mane that stands on end when a gnoll is angry.

### Names

Newborn gnoll are given a root name, typically that of a bone, plant, or animal (though never Hyena, as this is considered narcissistic and arrogant). As a gnoll reaches certain milestones in life, they add descriptors to their name. Root names are often passed down through families, while descriptors are chosen to fit the gnoll's personality, usually in raucous ceremonies.

**Example Names** Baobab, Jackal, Onyx Elephant in Shadows, Red Thorn, Unbent Iron Reed, White Acacia, Wistful Tooth, Woodpecker
