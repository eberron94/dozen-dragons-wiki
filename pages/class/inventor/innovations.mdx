...
**Traits** A construct companion has the construct trait. It's not a living creature, nor is it undead.

**HP** Your construct companion has 10 Hit Points, plus a number of Hit Points equal to 6 plus its Constitution modifier for each level you have.
...
**Ability Modifiers** A construct companion begins with the following base ability modifiers:
...
**Speed** Your construct companion has a Speed of 25 feet.
