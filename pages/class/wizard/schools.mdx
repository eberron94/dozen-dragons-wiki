...
{{{card "spell.focus.crb.protective-ward"}}}

#### Advanced School Spell [Wizard Feat]

{{{card "spell.focus.crb.energy-absorption"}}}
...
{{{card "spell.focus.crb.augment-summoning"}}}

#### Advanced School Spell [Wizard Feat]

{{{card "spell.focus.crb.dimensional-steps"}}}
...
{{{card "spell.focus.crb.diviners-sight"}}}

#### Advanced School Spell [Wizard Feat]

{{{card "spell.focus.crb.vigilant-eye"}}}
...
{{{card "spell.focus.crb.charming-words"}}}

#### Advanced School Spell [Wizard Feat]

{{{card "spell.focus.crb.dread-aura"}}}
...
{{{card "spell.focus.crb.force-bolt"}}}

#### Advanced School Spell [Wizard Feat]

{{{card "spell.focus.crb.elemental-tempest"}}}
...
{{{card "spell.focus.crb.warped-terrain"}}}

#### Advanced School Spell [Wizard Feat]

{{{card "spell.focus.crb.invisibility-cloak"}}}
...
{{{card "spell.focus.crb.call-of-the-grave"}}}

#### Advanced School Spell [Wizard Feat]

{{{card "spell.focus.crb.life-siphon"}}}
...
{{{card "spell.focus.crb.physical-boost"}}}

#### Advanced School Spell [Wizard Feat]

{{{card "spell.focus.crb.shifting-form"}}}
