...
**Class DC** is your potency with certain class features. Your class determines what ability score is used. Class DC is 10 plus your class DC proficiency and your class's key ability score modifier.
...
The three most common checks are attack rolls, skill checks, and saving throws. A roll is a Success when it beats the Difficulty Class (DC). If the roll is 10 points greater than the DC, it is instead a Critical Success, which has enhanced results for you. If the roll is less than the DC, you have a Failure, or a Critical Failure if you failed by 10 points.
