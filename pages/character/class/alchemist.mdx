...
{{{featureClass "Formula Book" level=1}}}
...
{{{featureClass "Alchemical Discovery^^†^^" level=3}}}
...
{{{featureClass "Powerful Alchemy^^†^^" level=5}}}
...
{{{featureClass "Field Discovery" level=5}}}
...
{{{featureClass "Perpetual Infusions" level=7}}}
...
{{{featureClass "Perpetual Potency" level=11}}}
...
You become trained in Medicine and can attempt a Crafting check instead of a Medicine check for any of Medicine's untrained and trained uses, in addition to any abilities granted by Medicine skill feats (e.g. Battle Medicine).
