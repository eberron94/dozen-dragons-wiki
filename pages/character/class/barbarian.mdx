...
{{{featureClass "Juggernaut" level=13}}}
...
-   **Jaw** 1d10 P (grapple, unarmed)

**Snake**

-   **Fist** 1d10 P (grapple, unarmed)

**Wolf**

-   **Jaw** 1d10 P (trip, unarmed)

{{{featureClass "Instinct Specialization" level=7}}}
...
{{{featureClass "Raging Resistance" level=9}}}
...
{{{featureClass "Greater Instinct Specialization" level=15}}}
...
{{{featureClass "Draconic Rage" level=1}}}
...
Increase the additional damage from Rage to 12.
...
{{{featureClass "Titan Mauler" level=1}}}
...
Increase the damage from Rage when using draconic rage from 10 to 18.
