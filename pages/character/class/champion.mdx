...
{{{featureClass "Champion's Code and Abhorrent Actions" level=1 altered=true}}}
...
{{{featureClass "Hero's Defiance" level=19}}}
...
{{{featureClass "Champion's Reaction" level=1 id='paladin'}}}
...
{{{featureClass "Champion's Reaction" level=1 id='Redeemer'}}}
...
{{{featureClass "Champion's Reaction" level=1 id='Liberator'}}}
